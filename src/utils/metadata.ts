...
const WEB_URL = "https://uni-archive.vercel.app"; // Replace with your actual URL
const IMAGE_URL = `${WEB_URL}/assets/image/logo/uniarchive.png`; // Replace with your actual image path
const DESCRIPTION =
