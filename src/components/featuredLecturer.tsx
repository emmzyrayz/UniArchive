...
export const FeaturedLecturer: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between rounded-[12px] m-2 p-4 mb-4">
      <div className="top">
        <span>Featured Lecturers</span>
      </div>
      <div className="flex flex-row items-center justify-center w-[98/>%]  gap-6">
