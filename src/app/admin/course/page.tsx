...
function CourseStats() {
  const { courses, isInitialized } = useCourse();
  return (
    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
      <div className="bg-white p-3 rounded border">
        <div className="font-medium text-gray-900">Total Courses</div>
...
function CourseDataManagerPage() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            The Course Data Manager is optimized for desktop use due to its complex interface and data management features.
          </p>
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <header className="mb-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Course Data Manager</h1>
          <p className="text-gray-600">
            Review and complete course information before uploading to the database
          </p>
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              <span className="font-medium">Tip:</span> Required fields are marked with a red border. 
              Add course details as needed. Save each course individually when complete.
            </p>
          </div>
          <CourseStats />
        </header>
...
export default function CourseDataManagerPageWithProvider() {
  return (
    <CourseProvider>
      <CourseDataManagerPage />
    </CourseProvider>
  );
}
